...
import sys
sys.path.insert(0, "/pscratch/sd/r/rhlozek/oriented_superclustering") 
...
# Describe the constraints on the input catalog. This is the file that 
...
#"/pscratch/sd/r/rhlozek/stacking/data/desi/stacking_points/"

stack_pts_file = f"{constraint_str}.csv"
print(stack_pts_file)
